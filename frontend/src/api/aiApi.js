...
const aiApi = {
   ...
   */
  summarize: (content) => axiosInstance.post('/api/ai/summary', { content }),
   ...
   */
  assist: (prompt, context = '') => axiosInstance.post('/api/ai/assist', { prompt, context }),
   ...
   */
  summarizeInstance: (instanceId) => axiosInstance.post('/api/ai/summary/instance', { instanceId }),
   ...
   */
  getSuggestions: (content) => axiosInstance.post('/api/ai/suggestions', { content }),
